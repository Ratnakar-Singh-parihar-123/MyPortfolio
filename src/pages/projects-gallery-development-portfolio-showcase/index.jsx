    ...
    const projects = [
        {
            ...
            description: "A comprehensive e-commerce management dashboard with real-time analytics, inventory tracking, and order management.",
            technologies: ["React", "Node.js", "PostgreSQL", "Chart.js", "Tailwind CSS"],
            timeline: "3 months",
            challenges: ["Real-time data synchronization", "Performance optimization", "Complex filtering"],
            learnings: ["Advanced React patterns", "Database optimization", "Real-time WebSocket connections"],
        ...
        },
        {
            ...
            technologies: ["React", "Redux Toolkit", "Firebase", "React Beautiful DND", "Material-UI"],
            timeline: "2 months",
            challenges: ["Drag and drop implementation", "Real-time collaboration", "State management complexity"],
            learnings: ["Redux Toolkit mastery", "Firebase real-time database", "Advanced UI interactions"],
        ...
        },
        {
            ...
            preview: "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=600&h=400&fit=crop",
            ...
            technologies: ["Vanilla JavaScript", "Service Workers", "Weather API", "CSS Grid", "LocalStorage"],
            timeline: "1 month",
            challenges: ["PWA implementation", "Offline functionality", "API data caching"],
            learnings: ["Service Worker patterns", "Progressive enhancement", "Mobile-first design"],
        ...
        },
        {
            ...
            description: "An intelligent chat interface with natural language processing, real-time messaging, and AI-powered response suggestions.",
            technologies: ["React", "TypeScript", "Socket.io", "OpenAI API", "Express.js", "MongoDB"],
            timeline: "4 months",
            challenges: ["Real-time messaging", "AI integration", "Type safety implementation"],
            learnings: ["TypeScript best practices", "AI API integration", "WebSocket architecture"],
        ...
        },
        {
            ...
            description: "A responsive portfolio website showcasing projects, skills, and professional experience with smooth animations.",
            technologies: ["React", "Tailwind CSS", "Framer Motion", "React Router", "React Helmet"],
            timeline: "3 weeks",
            challenges: ["Performance optimization", "SEO implementation", "Cross-browser compatibility"],
            learnings: ["Animation libraries", "SEO best practices", "Performance optimization"],
        ...
        },
        {
            ...
            description: "A personal finance tracker with expense categorization, budget planning, and visual analytics.",
            technologies: ["JavaScript ES6+", "Chart.js", "Local Storage", "CSS Flexbox", "PWA"],
            timeline: "6 weeks",
            challenges: ["Data visualization", "Local data persistence", "Budget calculations"],
            learnings: ["Chart.js mastery", "Financial calculations", "Data management"],
    ...
    const wipProjects = [
        {
            ...
            description: "Real-time social media analytics with sentiment analysis and engagement tracking.",
        ...
        },
        {
            ...
            description: "A React Native app for recipe sharing with meal planning and shopping list features.",
                        ...
                        <div className="container mx-auto px-6 lg:px-8">
                            ...
                            >
                                ...
                                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                    Highlighted projects that showcase advanced technical skills, innovative solutions,
                                    and significant impact on user experience and business objectives.
                                </p>
                            </motion.div>
                    ...
                    <section className="py-16 bg-muted/30">
                        <div className="container mx-auto px-6 lg:px-8">
                            ...
                            >
                                ...
                                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                    Complete portfolio of development work across different technologies,
                        ...
                        <div className="grid md:grid-cols-4 gap-8">
                            ...
                            <div className="md:col-span-2 space-y-4">
                                ...
                                <p className="text-muted-foreground max-w-md">
                                    Building exceptional digital experiences through innovative solutions,
                                    clean code architecture, and continuous learning.
                                </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2 text-muted-foreground">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-sm font-medium text-foreground">{wipProjects?.length}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
