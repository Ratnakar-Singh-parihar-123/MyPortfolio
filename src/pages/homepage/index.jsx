  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription?.setAttribute(
        "content",
        "Full-Stack Developer & Problem Solver passionate about creating exceptional digital experiences. Specializing in React, Node.js, and modern web technologies.",
      );
    } else {
      const meta = document.createElement("meta");
      meta.name = "description";
      meta.content =
        "Full-Stack Developer & Problem Solver UI/Ux passionate about creating exceptional digital experiences. Specializing in React, Node.js, and modern web technologies.";
