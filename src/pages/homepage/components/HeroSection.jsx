    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
        ...
        <motion.div
          ...
          className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            x: -mousePosition.x,
          ...
          transition={{ type: "spring", stiffness: 50, damping: 30 }}
          className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-l from-orange-500/20 via-red-500/20 to-yellow-500/20 rounded-full blur-3xl"
        />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <motion.div
            ...
            className="w-[600px] h-[600px] border-2 border-dashed border-blue-500/10 rounded-full"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
            className="absolute inset-0 w-[400px] h-[400px] border-2 border-dashed border-purple-500/10 rounded-full m-auto"
          />
          <motion.div
            animate={{ rotate: 360 }}
            transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
            className="absolute inset-0 w-[200px] h-[200px] border-2 border-dashed border-pink-500/10 rounded-full m-auto"
          />
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 xl:gap-20">
          ...
          >
            <div className="relative max-w-sm sm:max-w-md md:max-w-lg">
              ...
              {/* <motion.div
                initial={{ opacity: 0, scale: 0.5, x: -30, rotate: -10 }}
                animate={{ opacity: 1, scale: 1, x: 0, rotate: 0 }}
                transition={{ delay: 1.4, type: "spring", stiffness: 200 }}
                whileHover={{ scale: 1.1, rotate: -2, x: -5 }}
                className="absolute top-6 sm:top-8 -left-4 sm:-left-6 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 cursor-default group"
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-sm font-bold block">Aspiring</span>
              ...
              {/* <motion.div
                ...
                whileHover={{ scale: 1.1, rotate: 2, x: 5 }}
                className="absolute bottom-20 sm:bottom-24 -right-4 sm:-right-6 px-4 py-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-xl shadow-2xl hover:shadow-green-500/30 transition-all duration-300 cursor-default group"
              >
                <div className="flex items-center gap-2">
                  <motion.div
                  ...
                  <div>
                    <span className="text-sm font-bold block">MERN</span>
                    <span className="text-xs opacity-90">Stack Expert</span>
                  </div>
                </div>
              </motion.div> */}
