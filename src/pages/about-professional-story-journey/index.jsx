...
const AboutProfessionalStoryJourney = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About - Professional Story & Journey | Portfolio </title>
        <meta 
          name="description" 
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  <div><a href="/homepage-developer-portfolio-hero-experience" className="text-background/80 hover:text-background transition-colors">Home</a></div>
