...
// Custom hook for scroll lock with better handling
...
const ImageGallery = ({ 
  ...
  const nextImage = useCallback(() => {
    ...
    setTimeout(() => setIsAnimating(false), 400);
  }, [currentIndex, images.length, isAnimating, onIndexChange]);
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative w-full h-full overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100/50 to-gray-200/30 dark:from-gray-900/50 dark:to-gray-800/30"
      drag="x"
      ...
      <AnimatePresence>
        {isLoading && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 flex items-center justify-center bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-sm z-10"
          >
            <div className="relative">
              <div className="w-16 h-16 border-4 border-blue-500/20 border-t-blue-500 border-r-blue-400 rounded-full animate-spin" />
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  animate={{ rotate: 360 }}
                  transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
                >
                  <Icon name="Loader" size={28} className="text-blue-500" />
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <>
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-10 h-10 bg-black/70 backdrop-blur-md rounded-full flex items-center justify-center">
...
const ThumbnailGallery = ({ images, currentIndex, onSelect, isMobile }) => {
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Icon name="Image" size={16} className="text-gray-600 dark:text-gray-400" />
...
const OverviewTab = ({ project, isMobile }) => (
  <div className="space-y-6">
    ...
    {project.impact && (
      <div className="p-5 bg-gradient-to-br from-blue-50/50 to-white/50 dark:from-blue-900/20 dark:to-gray-900/20 rounded-2xl border border-blue-100/50 dark:border-blue-800/20 backdrop-blur-sm">
...
const TechnicalTab = ({ project, isMobile }) => (
  <div className="space-y-6">
    <div className="space-y-4">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
      {project.technologies?.map((tech, idx) => (
        <motion.div
          ...
          className="p-4 bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm hover:shadow-lg transition-all"
        >
          <div className="flex flex-col items-center gap-3">
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-100 to-purple-50 dark:from-purple-900/30 flex items-center justify-center">
              <Icon name="Code" size={24} className="text-purple-600 dark:text-purple-400" />
            </div>
        ...
        <div className="space-y-3">
          {project.challenges.map((challenge, idx) => (
            <motion.div
              ...
              className="p-4 bg-gray-50/50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700"
            >
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0">
                  <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-amber-100 to-amber-50 dark:from-amber-900/30 flex items-center justify-center">
...
const FeaturesTab = ({ project, isMobile }) => (
  <div className="space-y-6">
    <div className="space-y-4">
    ...
    <div className="grid gap-4">
      {project.features?.map((feature, idx) => (
        <motion.div
          ...
          className="group"
        >
          <div className="p-5 bg-gradient-to-br from-emerald-50/50 to-white/50 dark:from-emerald-900/10 dark:to-gray-900/10 rounded-2xl border border-emerald-100/50 dark:border-emerald-800/20 hover:border-emerald-200 dark:hover:border-emerald-700/30 transition-all backdrop-blur-sm">
            <div className="flex items-start gap-4">
              <motion.div
              ...
              <div className="flex-1">
                ...
                {typeof feature !== 'string' && feature.details && (
...
const ImpactTab = ({ project, isMobile }) => (
  <div className="space-y-6">
    <div className="space-y-4">
      <h3 className="text-2xl font-bold bg-gradient-to-r from-amber-600 to-amber-400 bg-clip-text text-transparent">
        Impact & Results
      </h3>
    </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        {project.metrics.map((metric, idx) => (
          <motion.div
            ...
            transition={{ delay: idx * 0.1 }}
            whileHover={{ scale: 1.05 }}
            className="p-5 bg-gradient-to-br from-amber-50/50 to-white/50 dark:from-amber-900/10 dark:to-gray-900/10 rounded-2xl border border-amber-100/50 dark:border-amber-800/20 backdrop-blur-sm text-center"
          >
            <div className="text-3xl font-bold bg-gradient-to-r from-amber-600 to-amber-400 bg-clip-text text-transparent mb-2">
              {metric.value}
            </div>
            <div className="flex items-center justify-center gap-2">
              <Icon name={metric.icon || "TrendingUp"} size={18} className="text-amber-500" />
    ...
    {project.testimonial && (
      <motion.div
        ...
        className="mt-6"
      >
        <div className="relative p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {project.learnings.map((learning, idx) => (
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: idx * 0.1 }}
              className="p-4 bg-gradient-to-br from-blue-50/50 to-white/50 dark:from-blue-900/10 dark:to-gray-900/10 rounded-xl border border-blue-100/50 dark:border-blue-800/20"
            >
              <div className="flex items-start gap-2">
                <div className="w-8 h-8 rounded-md bg-gradient-to-br from-blue-500 to-blue-400 flex items-center justify-center flex-shrink-0 mt-0.5">
...
const ProjectModal = ({ project, isOpen, onClose }) => {
  ...
  const tabs = useMemo(() => [
    ...
    { id: "impact", label: "Impact", icon: "TrendingUp", color: "amber" },
  ], []);
  ...
  const currentImage = useMemo(() => 
    hasGallery ? project.gallery[currentImageIndex] : project?.image,
    [hasGallery, project, currentImageIndex]
  );
  ...
  useEffect(() => {
    ...
    window.addEventListener("keydown", handleKeyDown);
    return () => window.removeEventListener("keydown", handleKeyDown);
  }, [isOpen, project, isFullscreen, isMobile, hasGallery, onClose]);
  ...
  const handleTouchEnd = useCallback((e) => {
    ...
    setTouchStart(null);
  }, [touchStart, handleNextImage, handlePrevImage]);
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="min-h-full flex items-start sm:items-center justify-center p-0 sm:p-4">
              <motion.div
                ...
                } bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-2xl overflow-hidden`}
                style={{
                  maxWidth: isMobile ? '100%' : isTablet ? '95%' : '90%',
                  boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)'
                }}
              >
                {/* Header */}
                <div className="sticky top-0 z-40 bg-gradient-to-b from-white/95 via-white/90 to-white/85 dark:from-gray-900/95 dark:via-gray-900/90 dark:to-gray-900/85 backdrop-blur-xl border-b border-gray-200/30 dark:border-gray-700/30 px-4 py-3 sm:px-6 sm:py-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.9 }}
                      onClick={onClose}
                      className="relative w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      aria-label="Close"
                    >
                ...
                {/* Main Content */}
                <div className={`flex flex-col ${isDesktop ? 'lg:flex-row' : ''} h-[calc(100vh-4rem)] sm:h-auto`}>
                  {/* Left Column - Gallery */}
                  <div className={`${
                    isDesktop ? 'lg:w-1/2' : ''
                  } p-4 sm:p-5 lg:p-6 border-b ${
                    isDesktop ? 'lg:border-b-0 lg:border-r' : ''
                    ...
                    <div className="space-y-4 sm:space-y-5">
                      ...
                      {hasGallery && (
                        <div className="flex items-center justify-between mb-2">
                          <div className="text-sm text-gray-500 dark:text-gray-400">
                            {!isMobile && (
                              <>
                                <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs mr-1">← →</kbd>
                                Navigate • 
                              </>
                            )}
                      ...
                      {/* Main Image Gallery */}
                      {showGallery && project.gallery?.length > 1 ? (
                        ...
                        <>
                          ...
                          >
                            <ImageGallery
                              images={hasGallery ? project.gallery : [project.image]}
                          ...
                          {/* Thumbnails */}
                          {hasGallery && project.gallery.length > 1 && !isMobile && (
                            <ThumbnailGallery
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {project.duration && (
                          <div className="p-3 bg-gradient-to-br from-white/50 to-white/30 dark:from-gray-800/50 dark:to-gray-900/30 rounded-xl border border-gray-200/30 dark:border-gray-700/30 backdrop-blur-sm">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        {project.githubUrl && (
                          <Button
                            ...
                            iconName="Github"
                            iconPosition="left"
                            className="flex-1 border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-600"
                  ...
                  <div className={`${isDesktop ? 'lg:w-1/2' : ''} flex flex-col`}>
                    {/* Tabs */}
                    <div className="sticky top-0 z-30 bg-gradient-to-b from-white/95 to-white/90 dark:from-gray-900/95 dark:to-gray-900/90 backdrop-blur-xl border-b border-gray-200/30 dark:border-gray-700/30">
                      <div className="flex overflow-x-auto scrollbar-hide">
                        {tabs.map((tab) => (
                          <motion.button
                            key={tab.id}
                            onClick={() => setActiveTab(tab.id)}
                            className={`relative flex-1 min-w-0 px-4 py-3 text-sm font-medium transition-colors ${
                              activeTab === tab.id
                    ...
                    <div
                      ref={contentRef}
                      className="flex-1 overflow-y-auto p-4 sm:p-5 lg:p-6 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600"
                      style={{
                        maxHeight: isMobile ? 'calc(100vh - 300px)' : 
                                  isTablet ? 'calc(90vh - 200px)' : 
                                  'calc(95vh - 200px)'
                      }}
                    >
                      <AnimatePresence mode="wait">
                        ...
                        >
                          {activeTab === "overview" && (
                            <OverviewTab project={project} isMobile={isMobile} />
                          )}
                          {activeTab === "technical" && (
                            <TechnicalTab project={project} isMobile={isMobile} />
                          )}
                          {activeTab === "features" && (
                            <FeaturesTab project={project} isMobile={isMobile} />
                          )}
                          {activeTab === "impact" && (
                            <ImpactTab project={project} isMobile={isMobile} />
                          )}
                        </motion.div>
                      </AnimatePresence>
                    </div>
